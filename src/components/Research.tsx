...
const Research: React.FC<ResearchProps> = ({ darkMode, language }) => {
  ...
  return (
    <section id="research" className={`py-16 sm:py-20 md:py-24 lg:py-32 ${
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className={`p-8 md:p-10 rounded-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 cursor-pointer group ${
            darkMode 
            ...
            <div className="flex items-start space-x-8">
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div className={`px-4 py-2 rounded-full text-sm font-bold transition-all duration-300 group-hover:scale-105 ${
                    darkMode 
                ...
                <h4 className={`text-2xl font-semibold mb-6 transition-all duration-300 group-hover:scale-105 ${
                  darkMode ? 'text-slate-200' : 'text-gray-800'
                }`}>
                  "Automatic Detection of Leaf Diseases in Hibiscus Plants Using Live Image Dataset with UI"
                </h4>
                
                <p className={`text-lg mb-8 leading-relaxed transition-all duration-300 group-hover:scale-105 ${
                  darkMode ? 'text-slate-300' : 'text-gray-700'
                }`}>
                  This research presents an innovative approach to automated plant disease detection using 
                  convolutional neural networks (CNN) with a focus on hibiscus plants. The system achieved 
                  remarkable accuracy in identifying various leaf diseases through live image processing.
                </p>
                
                {/* Key Metrics */}
                <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-8">
                  <div className={`text-center p-6 rounded-2xl transition-all duration-500 hover:scale-110 cursor-pointer ${
                ...
                {/* Technologies Used */}
                <div className="mb-8">
                  <h5 className={`text-lg font-semibold mb-4 transition-all duration-300 group-hover:scale-105 ${
                    darkMode ? 'text-slate-200' : 'text-gray-800'
                  }`}>
                    Technologies & Methods:
                  </h5>
                  <div className="flex flex-wrap gap-3">
                    {['CNN', 'Deep Learning', 'Image Processing', 'Python', 'TensorFlow', 'Computer Vision', 'UI Development'].map((tech, index) => (
                      <span
                        key={index}
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex items-center space-x-3">
                    <Award size={20} className={darkMode ? 'text-yellow-400' : 'text-yellow-600'} />
                    <span className={`text-lg font-medium ${darkMode ? 'text-slate-300' : 'text-gray-700'}`}>
                      IEEE CYBERCOM
                    </span>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 lg:gap-10 mb-12 md:mb-16 lg:mb-16">
            <div className={`text-center p-8 rounded-2xl transition-all duration-500 hover:scale-110 hover:-translate-y-2 cursor-pointer ${
              darkMode ? 'bg-slate-800/30' : 'bg-white/30'
            } backdrop-blur-sm hover:shadow-2xl`}>
              <TrendingUp size={40} className={`mx-auto mb-6 ${
                darkMode ? 'text-green-400' : 'text-green-600'
              }`} />
              <h4 className={`font-bold text-xl mb-3 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
                High Impact
              </h4>
            ...
            <div className={`text-center p-8 rounded-2xl transition-all duration-500 hover:scale-110 hover:-translate-y-2 cursor-pointer ${
              ...
              <BookOpen size={40} className={`mx-auto mb-6 ${
            ...
            <div className={`text-center p-8 rounded-2xl transition-all duration-500 hover:scale-110 hover:-translate-y-2 cursor-pointer ${
              ...
              <Award size={40} className={`mx-auto mb-6 ${
          ...
          <div className={`p-8 rounded-2xl transition-all duration-500 hover:scale-105 cursor-pointer ${
            darkMode ? 'bg-slate-800/50 border-2 border-slate-700/50' : 'bg-white/50 border-2 border-gray-200/50'
          } backdrop-blur-sm hover:shadow-2xl`}>
            <h3 className={`text-2xl font-bold mb-6 transition-all duration-300 hover:scale-105 ${
              darkMode ? 'text-white' : 'text-gray-900'
            }`}>
              🔬 Research Interests
            </h3>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={index} className="flex items-center space-x-4 transition-all duration-300 hover:scale-105">
                  <div className={`w-3 h-3 rounded-full ${
                    darkMode ? 'bg-purple-400' : 'bg-orange-500'
                  }`} />
                  <span className={`text-lg ${darkMode ? 'text-slate-300' : 'text-gray-700'}`}>
                    {interest}
                  </span>
                </div>
              ))}
