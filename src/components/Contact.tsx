      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
          ...
          <div className="space-y-10">
            <div>
              <h3
                className={`text-3xl font-bold mb-8 transition-all duration-500 hover:scale-105 ${
                ...
                {contactInfo.map((info, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <p
                          className={`text-lg font-medium transition-all duration-300 group-hover:scale-105 ${
            ...
            <div>
              <h3
                className={`text-2xl font-bold mb-6 transition-all duration-500 hover:scale-105 ${
                  darkMode ? "text-white" : "text-gray-900"
                }`}
              >
                🌐 Connect With Me
            ...
            >
              <h3
                className={`text-2xl font-bold mb-4 transition-all duration-300 hover:scale-105 ${
                  darkMode ? "text-white" : "text-gray-900"
                }`}
              >
              ...
              <p
                className={`mb-6 text-lg transition-all duration-300 hover:scale-105 ${
                  darkMode ? "text-slate-300" : "text-gray-700"
                }`}
              >
                I'm always open to discussing new opportunities, innovative
                projects, and ways to contribute to meaningful technology
                solutions.
              </p>
          ...
          {/* Contact Form */}
          <div
            className={`p-10 rounded-2xl transition-all duration-500 hover:scale-105 ${
              darkMode
